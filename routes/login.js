...
router.post("/signup", validate(validation, {}, {}), async (req, res) => {
    ...
    bcrypt.hash(req.body.password, 10, function (err, hash) {
        new User({ id: uid, defaultRender: true, created: new Date(), username: req.body.username, password: hash, amulets: 100, about: "I don't have a bio, but I can change that!" }).save();
