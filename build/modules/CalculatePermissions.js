...
exports.CalculatePermissions = void 0;
const GetUser = __importStar(require("./GetUser"));
async function CalculatePermissions(ranks) {
    if (typeof ranks == "string")
        ranks = (await GetUser.getUser(ranks, "anolet")).ranks;
    if (!ranks)
        return [];
